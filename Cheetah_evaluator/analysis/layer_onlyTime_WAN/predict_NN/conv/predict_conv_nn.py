...
tuner.search(x_train, y_train, epochs=200, validation_data=(x_val, y_val), verbose=2)  # Set verbose to 2
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('conv_best_plot_' + name + '_' + str(EPOCH) + 'ep.png')

best_model.save('best_model_conv_' + name + '_' + str(EPOCH) + 'ep.keras')