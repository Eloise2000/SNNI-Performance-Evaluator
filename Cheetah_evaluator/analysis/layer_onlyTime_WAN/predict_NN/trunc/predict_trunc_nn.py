...
plt.title('Truncation Training and Validation Loss for '+name)
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.savefig('trunc_best_plot_' + name + '_' + str(EPOCH) + 'ep.png')

best_model.save('best_model_trunc_' + name + '_' + str(EPOCH) + 'ep.keras')