...
RNN_folderPath = "/home/eloise/eloise/script/analysis/layer_onlyTime_LAN/predict_RNN/"
...
if __name__ == "__main__":
    end_all_layers, start_all_layers = generate("sqnet", 1, 1)
    ...
    end_time2 = time.time()
    print("**** Here is ", (end_time2 - start_time) * 1000)
