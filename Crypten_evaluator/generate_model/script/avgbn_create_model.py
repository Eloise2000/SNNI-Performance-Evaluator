...
Author: Eloise Zhang
Date: 12 July 2024
Description: This script generates several neural network models with Conv2d, Relu, AvgPool and BatchNorm2d layers.
"""
...
if __name__ == "__main__":
    ...
    }, f"{save_path}avgbn_model_rs{random_seed}.pth", src=0)
    print(f"Non-encrypted model saved in {save_path}avgbn_model_rs{random_seed}.pth with random seed {random_seed}.")
