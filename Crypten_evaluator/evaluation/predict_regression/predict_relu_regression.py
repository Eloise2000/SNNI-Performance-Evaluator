...
Author: Eloise Zhang
Date: 12 July 2024
Description: This script build analytical mdoel for ReLU Layer.
"""
...
'''physical operations'''
X['FLOPs'] = df["relu_N"] * df["relu_HI"] * df["relu_WI"] * df["relu_CI"]

y = df['relu_time_cost']

# Plot the relationship of flops and time cost
...
'''physical operations'''
X_single['FLOPs'] = [df_row["relu_N"] * df_row["relu_HI"] * df_row["relu_WI"] * df_row["relu_CI"]]
...
real_time = df_row['relu_time_cost']
