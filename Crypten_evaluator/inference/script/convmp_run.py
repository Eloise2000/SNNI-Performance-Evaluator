...
Author: Eloise Zhang
Date: 12 July 2024
Description: This script runs SNNI in 2PC, and tests the inference runtime for Conv2d, Relu and MaxPool layers.
"""
...
class DynamicModel(cnn.Module):
    ...
    def check_maxpool(self, in_size, in_channels, pool_kernel_size, pool_strides):
        ...
        return out_size * out_size * pool_kernel_size * pool_kernel_size * in_channels < 48880000 # For local running, should be smaller
...
if __name__ == "__main__":
    ...
    if rank == SERVER:
        ...
        checkpoint = torch.load(f"{model_folder_path}convmp_model_rs{random_seed}.pth")
