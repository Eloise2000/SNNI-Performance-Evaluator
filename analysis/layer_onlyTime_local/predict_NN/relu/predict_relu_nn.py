...
tuner = RandomSearch(
    ...
    project_name='230925-3'  # Name of the tuning project
)
...
history = best_model.fit(x_train, y_train, epochs=150, validation_data=(x_val, y_val))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('relu_best_plot_' + name + '.png')

best_model.save('best_model_relu_' + name + '.keras')