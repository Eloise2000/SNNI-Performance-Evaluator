...
LR_folderPath = "/home/eloise/eloise/script/analysis/per_layer_onlyTime/predict_regression/LR_model_without_sqnet/"
''' Predict conv '''
reg_conv = load(LR_folderPath + 'conv_client_LR_model.joblib')
scaler_conv = load(LR_folderPath + 'conv_client_scaler.joblib')
...
''' Predict relu '''
reg_relu = load(LR_folderPath + 'relu_client_LR_model.joblib')
scaler_relu = load(LR_folderPath + 'relu_client_scaler.joblib')
...
''' Predict maxpool '''
reg_maxpool = load(LR_folderPath + 'mp_client_LR_model.joblib')
scaler_maxpool = load(LR_folderPath + 'mp_client_scaler.joblib')
...
''' Predict avgpool '''
reg_avgpool = load(LR_folderPath + 'ap_client_LR_model.joblib')
scaler_avgpool = load(LR_folderPath + 'ap_client_scaler.joblib')
