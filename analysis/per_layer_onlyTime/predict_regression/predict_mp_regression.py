...
# plt.legend()
# plt.savefig('mape_mp_MoreThan1000.png')  # Provide the desired file name and extension
# plt.savefig('mape_mp_MoreThan500.png')  # Provide the desired file name and extension
# plt.savefig('mape_mp_all.png')  # Provide the desired file name and extension
