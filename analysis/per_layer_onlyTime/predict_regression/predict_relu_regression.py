...
# plt.legend()
# plt.savefig('mape_relu_MoreThan1000.png')  # Provide the desired file name and extension
# plt.savefig('mape_relu_MoreThan100.png')  # Provide the desired file name and extension
# plt.savefig('mape_relu_all.png')  # Provide the desired file name and extension
