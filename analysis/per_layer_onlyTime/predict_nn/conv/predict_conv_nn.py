...
tuner.search(x_train, y_train, epochs=1, validation_data=(x_val, y_val), verbose=2)  # Set verbose to 2
...
best_model.fit(x_train, y_train, epochs=200, validation_data=(x_val, y_val))
