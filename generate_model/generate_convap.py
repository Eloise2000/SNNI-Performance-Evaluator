...
for _ in range(5):  # Assuming 8 convolutional layers
    ...
    # Random add relu layer after conv
...
argmax_output = tf.argmax(logits, axis=1, name='argmax_output')
